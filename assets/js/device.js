...
(function () {
    ...
    function applyDevice() {
        const manual = localStorage.getItem('mf_manual_device');
        const info = detectDevice();
        if (['mobile','tablet','desktop'].includes(manual)) { info.type = manual; info.label = DEVICE_LABELS[manual] || info.label; }
